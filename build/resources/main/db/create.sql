...
CREATE TABLE properties_tenants(id serial PRIMARY KEY, tenant_id integer, property_id integer);
CREATE TABLE landlords_properties(id serial PRIMARY KEY, landlord_id integer, property_id integer);
